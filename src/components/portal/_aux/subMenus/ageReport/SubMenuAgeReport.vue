    ...
    <ul>
      <li :class="{ 'active-route' : menu.selected === 'home' }">
        <div class="container-items" @click="SAVE_MENU({selected: 'home', stage: 'decrease'})">
          <router-link to="/ageReport/home" active-class="active-route">
            <div class="item-menu">
      ...
      <li :class="{ 'active-route' : menu.selected === 'management' }"
        ...
        <ul :class="{ 'selected' : menu.selected === 'management' }">
          <li>
            <div class="container-items">
              <router-link to="/ageReport/gerenciamento/usuarios"
          ...
          <li>
            <div class="container-items">
              <router-link to="/ageReport/gerenciamento/relatorios"
                           active-class="active-route-submenu"
                           @click="[loadingPage(),
                                SAVE_MENU({stage: 'decrease'})]">
                <div class="item-submenu">
